    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* <div className="space-y-2" data-aos="fade-up" data-aos-duration="1400">
                <label className="block text-sm font-medium text-white">
                    Foto do Perfil <span className="text-gray-400">(optional)</span>
                </label>
                    ...
                    {imagePreview ? (
                        ...
                        <div className="w-full" >
                            ...
                            >
                                ...
                                <span>Escolha a foto do perfil</span>
                            </button>
        ...
        <div className="p-6 border-b border-white/10" data-aos="fade-down" data-aos-duration="800">
            <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold text-white">
                    Comentários <span className="text-indigo-400">({comments.length})</span>
                </h3>
            </div>
        </div>
            ...
            <div className="space-y-4 h-[500px] overflow-y-auto custom-scrollbar" data-aos="fade-up" data-aos-delay="200">
                {comments.length === 0 ? (
                    <div className="text-center py-8" data-aos="fade-in">
                        ...
                        <p className="text-gray-400">Nenhum comentário ainda. Inicie a conversa!</p>
                    </div>
                ) : (
