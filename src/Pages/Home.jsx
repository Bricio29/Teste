...
const WORDS = ["Estudante de Sistemas de Informação", "Technological Explorer"];
const TECH_STACK = ["Javascript", "React", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Bricio29" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/briciodev/" },
  { icon: Instagram, link: "https://www.instagram.com/briciodev/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Transforme ideias em um site moderno e intuitivo.
                </p>
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  ...
                  <CTAButton href="#Contact" text="Fale Comigo" icon={Mail} />
                </div>
